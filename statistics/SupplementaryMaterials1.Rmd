...
subtitle: "Supplementary Materials 1: Statistical Analysis"
output:
  html_document:
    theme: journal
...
<!--        report_cfa_indices(comparison_4vs1, 1, name="<4-factors>"), -->
<!--        " over the one-factor ", -->
<!--        report_cfa_indices(comparison_4vs1, 2, name="<1-factor>")) -->
<!-- ``` -->
...
<!-- ```{r warning=FALSE, message=FALSE} -->
<!-- paste0("We then compared the four-factors solution with the initial hypothetic model with which we built the scale, which favoured the four-factors model ", report_cfa_indices(comparison_4vsinitial, 2, name="<hypothetic>")) -->
<!-- ``` -->
...
<!--        report_cfa_indices(comparison_4vs4short, 2, name="<3-items>"), -->
<!--        " outperformed all versions, including 5-items ", -->
<!--        report_cfa_indices(comparison_4vs4short, 4, name="<5-items>"), -->
<!--        " and 4-items ", -->
<!--        report_cfa_indices(comparison_4vs4short, 3, name="<4-items>"),  -->
